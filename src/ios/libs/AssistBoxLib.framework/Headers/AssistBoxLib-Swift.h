...
#import "/Users/yildirayyilmaz/AssistBoxLibIOS/AssistBoxLib/AssistBoxLib/Plugins/com.dooble.phonertc/Bridging-Header.h"
...
SWIFT_CLASS_NAMED("ASTDocumentPicker")
@interface ASTDocumentPicker : ASTPlugin
- (void)getFile:(ASTInvokedUrlCommand * _Nonnull)command;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UIDocumentPickerViewController;

@interface ASTDocumentPicker (SWIFT_EXTENSION(AssistBoxLib)) <UIDocumentPickerDelegate>
...
SWIFT_CLASS("_TtC12AssistBoxLib10PCObserver")
...
SWIFT_CLASS_NAMED("PhoneRTCPlugin")
@interface PhoneRTCPlugin : ASTPlugin
- (void)createSessionObject:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)call:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)receiveMessage:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)renegotiate:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)disconnect:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)startCapture:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)stopCapture:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)sendMessage:(NSString * _Nonnull)callbackId message:(NSData * _Nonnull)message;
- (void)setVideoView:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)hideVideoView:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)showVideoView:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)initLocalAudioTrack SWIFT_METHOD_FAMILY(none);
- (void)initLocalVideoTrack SWIFT_METHOD_FAMILY(none);
- (void)initLocalVideoTrack:(NSString * _Nonnull)camera SWIFT_METHOD_FAMILY(none);
- (void)addRemoteVideoTrack:(RTCVideoTrack * _Nonnull)videoTrack;
- (void)removeRemoteVideoTrack:(RTCVideoTrack * _Nonnull)videoTrack;
- (void)refreshVideoContainer;
- (void)onSessionDisconnect:(NSString * _Nonnull)sessionKey;
- (void)switchOffFlashLight;
- (void)changeCameraDirection:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)onDidRotate1:(NSNotification * _Nonnull)notification;
- (void)checkPermissions:(ASTInvokedUrlCommand * _Nonnull)command;
- (void)onDidRotate:(NSNotification * _Nonnull)notification;
