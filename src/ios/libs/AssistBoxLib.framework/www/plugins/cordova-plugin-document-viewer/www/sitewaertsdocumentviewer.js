...
var AST_HANDLE = "SitewaertsDocumentViewer";

var AST_HANDLE_ACTIONS = {
...
function installApp(options, onSuccess, onError)
{
    ...
    try
    {
        ...
        exec(
                ...
                AST_HANDLE,
                AST_HANDLE_ACTIONS.INSTALL_VIEWER_APP,
                [
                    {options: options}
                ]
        );
    ...
    getSupportInfo: function (onSuccess, onError)
    {
        ...
        try
        {
            exec(
                    ...
                    AST_HANDLE,
                    AST_HANDLE_ACTIONS.GET_SUPPORT_INFO,
                    []
            );
        }
        catch (e)
    ...
    viewDocument: function (url, contentType, options, onShow, onClose, onMissingApp, onError, linkHandlers)
    {
        ...
        function _fireResume()
        {
            exec(
                    ...
                    _logError,
                    AST_HANDLE,
                    AST_HANDLE_ACTIONS.APP_RESUMED,
                    []
            );
        }
                    ...
                    function ()
                    {
                        _beforeShow(function ()
                        {
                            exec(
                                    ...
                                    _onError,
                                    AST_HANDLE,
                                    AST_HANDLE_ACTIONS.VIEW_DOCUMENT,
                                    [
                                        {
                                            url: url,
